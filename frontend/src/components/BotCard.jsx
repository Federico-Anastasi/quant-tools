  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 flex items-start justify-between mb-3">
        ...
        {/* Strategy Badge - Aligned with chart colors */}
        <div className={`${strategyStyle.bg} ${strategyStyle.border} border rounded px-2 py-0.5 text-xs font-bold ${strategyStyle.text} shrink-0`}>
          {strategyStyle.label}
        </div>
      </div>
